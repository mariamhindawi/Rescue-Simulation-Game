...
public class Patrick extends JFrame implements MyWindow {
	...
	public Patrick(ActionListener emergencyService) {

		super();
		this.emergencyService = emergencyService;
		setExtendedState(MAXIMIZED_BOTH);
		setTitle("SAVE PATRICK");
		...
		gameo2.setBackground(Color.pink);
		...
		ImageIcon img7 = new ImageIcon("patrickcrying.jpg");
		...
		UnitsPanel.setBackground(Color.pink);
		...
		UnitsPanelInfo.setBackground(Color.pink);
