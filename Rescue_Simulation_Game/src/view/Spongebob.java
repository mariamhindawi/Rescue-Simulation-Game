...
public class Spongebob extends JFrame implements MyWindow {
	...
	public Spongebob(ActionListener emergencyService) {

		super();
		this.emergencyService = emergencyService;
		setExtendedState(MAXIMIZED_BOTH);
		setTitle("SAVE SPONGEBOB");
		...
		close.setBackground(new Color(255,255,51));
		...
		playagain.setBackground(new Color(255,255,51));
		...
		gameo2.setBackground(new Color(255,255,51));
		...
		ImageIcon img7 = new ImageIcon("spongebobcrying.jpg");
		...
		JScrollPane hintscroll = new JScrollPane(hintpanel3, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
				JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);

		currentcycle.setBackground(new Color(204,229,255));
		currentcycle.setOpaque(true);
	
		nextcycle.setBackground(new Color(255,255,51));
		...
		Gameplay.setBackground (new Color(255,255,51));
		Gameplay.setFont(new Font("Centaur", Font.ITALIC, 22));
		
		information.setBackground(new Color(255,255,51));
		information.setFont(new Font("Centaur", Font.ITALIC, 22));
		information.setBorder(new LineBorder(Color.black, 2));
	

		UnitsPanelInfo.setBackground(new Color(255,255,51));
